                ...
                <div class="items-center">
                    <div class="flex">
                        ...
                        <div>
                            ...
                            <h4>
                                    <% Double price = (Double) request.getAttribute("orderPrice");
            ...
            <div class="wg-chart">
                <div class="items-center">
                    <div class="flex">
                        ...
                        <div>
                            <div class="body-text">Tổng đơn hàng</div>
                            <h4><%=request.getAttribute("orderTotal")%>
                            </h4>
                        </div>
                    </div>
            ...
            <div class="wg-chart">
                <div class="items-center">
                    <div class="flex">
                        ...
                        ></i>
                        <div>
                            <div class="body-text">Tổng khách hàng đăng kí</div>
                            <h4><%=request.getAttribute("userTotal")%>
                            </h4>
                        </div>
                    </div>
