...
<%--                        <input hidden="hidden" value="${cate.id}" name="id">--%>
                        <div class="col">
                            ...
                            <input value="<%=request.getAttribute("target")%>" id="name" name="name" type="text" class="form-control"
                                   aria-label="First name">
                        </div>
                        <div class="col">
                            <input value="<%=request.getAttribute("nameImg")%>" id="cateImg" name="cateImg" type="file"
                                   class="form-control"
