...
<%--    <span> ${msg} </span>--%>
    ...
    <form action="<%=request.getContextPath()%>/update-user" method="POST">
        ...
        <input type="text" value="${customers.name}" id="username" name="username" placeholder="Nhập tên người dùng" required>

        <label for="email">Email</label>
        <input readonly type="email" value="${customers.email}" id="email" name="email" placeholder="Nhập email người dùng" required>

        <label for="password">Mật khẩu</label>
        <input readonly  type="password" value="${customers.pass}" id="password" name="password" placeholder="Nhập password người dùng" required>
