        ...
        <table id="myTable" class="display" style="width:100%; color: #fff">
          ...
          <c:forEach items="${listA}" var="o">
            <tr>
              ...
              <td><img src="<%=request.getContextPath()%>/assets/pic/Aboutus/${o.member1}"/></td>
              <td><img src="<%=request.getContextPath()%>/assets/pic/Aboutus/${o.member2}"/></td>
              <td><img src="<%=request.getContextPath()%>/assets/pic/Aboutus/${o.member3}"/></td>
              <td>
