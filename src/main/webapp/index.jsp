  ...
  <section class="why-choose-section">
    <div class="why-choose-container">
      ...
      <div class="wh-col-right">
        <div class="img-wrap">
          <img
                  src="./assets/pic/01-halloween-stamp-carousel_be8cfa5b-2f40-4bb7-96fc-d2d0c6da8af3_800x.webp"
                  alt="Image"
                  class="img-fluid"
          />
        </div>
      ...
      <div class="whp-left">
        <div class="imgs-grid">
          <div class="grid grid-1">
            <img src="./assets/pic/orange" alt="" />
          </div>
          <div class="grid grid-2">
            <img src="./assets/pic/Gifts_For_Artists.webp" alt="" />
          </div>
          <div class="grid grid-3">
            <img src="./assets/pic/pic_pens" alt="" />
          </div>
        </div>
      </div>
      <div class="whp-right">
