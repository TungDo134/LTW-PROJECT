  ...
  <div class="container">
        <div class="container_Info">
            <div class="left-column">
                <div class="detailProduct">
                    <div class="product-images">
                        <img class="main-image" src="https://cdn1.fahasa.com/media/catalog/product/8/8/8809387693926-mau3.jpg" alt="Sản phẩm">
                        <div class="thumbnail-container">
                            <img class="thumbnail" src="https://cdn1.fahasa.com/media/catalog/product/8/8/8809387693926-mau3-_3_.jpg" alt="Thumb 1">
                            <img class="thumbnail" src="https://cdn1.fahasa.com/media/catalog/product/8/8/8809387693926-mau4-_7__2.jpg" alt="Thumb 2">
                            <img class="thumbnail" src="https://cdn1.fahasa.com/media/catalog/product/8/8/8809387693926-mau4-_4__2.jpg" alt="Thumb 3">
                        </div>
                    </div>
                    <div class="product-info">
                        <h1 class="product-title">Sổ Bonicrew A5 - Giấy Trơn - 64 Trang - Oxford SWN1A5</h1>
                        <div class="btn-container">
                            <button class="btn">Thêm vào giỏ hàng</button>
                            <button class="btn btn-buy">Mua ngay</button>
                        </div>
                        <div class="policy">
                            <h2>Chính sách ưu đãi của... :</h2>
                            <p class="policy-item"><strong>🕒 Thời gian giao hàng:</strong> Giao nhanh và uy tín</p>
                            <p class="policy-item"><strong>🔄 Chính sách đổi trả:</strong> Đổi trả miễn phí toàn quốc</p>
                            <p class="policy-item"><strong>🎁 Chính sách khách sỉ:</strong> Ưu đãi khi mua số lượng lớn</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="right-column">
                <div class="infoPro">
                    <h2><button class="new" >MỚI</button> Sổ Bonicrew A5 - Giấy Trơn - 64 Trang - Oxford SWN1A5 - Màu Vàng</h2>
                ...
                <div class="describe">
                    ...
                    <p><strong>Sổ Bonicrew A5 - Giấy Trơn - 64 Trang - Oxford SWN1A5</strong> sử dụng loại giấy cao cấp từ Hàn Quốc láng, mịn, không lóa mắt, phù hợp để viết và vẽ rất dễ dàng.</p>
            
                    <p>Sản phẩm được thiết kế gáy độc đáo, có thể gập lại mà không để lại nếp gấp, rất tiện lợi.</p>
                        
                    <p>Kích cỡ khổ giấy A5 cho bạn thỏa sức ghi chép. Sổ Bonicrew thích hợp dùng cho học sinh, sinh viên, nhân viên văn phòng để phục vụ công việc học tập hàng ngày.</p>
                </div>         
            </div>
        </div>
        ...
        <div class="rating-container">
            <div class="left_rate">
                ...
                <div class="score_rating">
                    <div class="rating-score">0<span>/5</span></div>
                    <div class="stars">
            ...
            <div class="right_rating">
                <div class="rating-bars">
                    <div class="rating-bar"><span>5 sao</span> <div class="bar"><div class="bar-filled"></div></div> <span>0%</span></div>
                    <div class="rating-bar"><span>4 sao</span> <div class="bar"><div class="bar-filled"></div></div> <span>0%</span></div>
                    <div class="rating-bar"><span>3 sao</span> <div class="bar"><div class="bar-filled"></div></div> <span>0%</span></div>
                    <div class="rating-bar"><span>2 sao</span> <div class="bar"><div class="bar-filled"></div></div> <span>0%</span></div>
                    <div class="rating-bar"><span>1 sao</span> <div class="bar"><div class="bar-filled"></div></div> <span>0%</span></div>
                </div>
            </div>
