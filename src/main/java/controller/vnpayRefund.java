...
//
//        //Command: refund
//        String vnp_RequestId = VNPayReturnServlet.getRandomNumber(8);
//        String vnp_Version = "2.1.0";
//        String vnp_Command = "refund";
//        String vnp_TmnCode = VNPayReturnServlet.vnp_TmnCode;
...
//
//        String vnp_IpAddr = VNPayReturnServlet.getIpAddress(req);
//
...
//
//        String vnp_SecureHash = VNPayReturnServlet.hmacSHA512(VNPayReturnServlet.secretKey, hash_Data.toString());
//
//        vnp_Params.addProperty("vnp_SecureHash", vnp_SecureHash);
//
//        URL url = new URL (VNPayReturnServlet.vnp_ApiUrl);
